...
<div class="tdare">
    <table width="100%" cellspacing="0" class="dataTable">
        ...
        <tr class="tatr1" style="background-color:#B9FFFF;">
            <td width="16%" class="firstCell">采购单号</td>
            <td width="16%">采购日期</td>
            <td width="16%">供应商</td>
        	<td width="16%">供应商单号</td>
            <td width="10%" class="table-center">入库类型</td>
            <td>采购员</td>
        </tr>
        </thead>
        <tbody>
        <tr class="tatr2" style="background-color:#E1FFF0;">
            ...
            <td class="table-center"><?php if ($this->_var['purchase']['purchase_type'] == 0): ?>采购入库<?php elseif ($this->_var['purchase']['purchase_type'] == 2): ?><span style="color:red;">采购退货</span><?php else: ?>其他<?php endif; ?></td>
    ...
    <table width="100%" cellspacing="0" class="dataTable">
        ...
        <tbody>
        <?php $_from = $this->_var['purchase']['pd']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods');if (count($_from)):
...
?>
    ...
    <form method="post" name="export_form" id="export_form" action="index.php?app=purchase&amp;act=export">
