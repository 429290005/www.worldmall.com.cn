...
function sub_payment(o, id){
	...
	warning.html('正在提交...');
	$.getJSON("index.php?app=inventory&act=payment", {id: id, money: money}, function(data){
		if (data.done){
			warning.html('修改成功');
			location.reload();
		}
...
function subInvalid(id) {
	...
	$.getJSON("index.php?app=inventory&act=invalid", {id: id}, function(data){
		if (data.done){
			location.reload();
		}
	});
...
function confirm_submit() {
	...
	$.get("index.php?app=inventory&act=export_all",{field:field, search_name:search_name, add_time_from:add_time_from, add_time_to:add_time_to, purchase_type:purchase_type, status:status, is_void:is_void});
}
</script>
<div id="rightTop">
    <p>盘亏盘盈</p>
    <ul class="subnav">
        ...
        <!--<li><a class="btn4" href="index.php?app=inventory&amp;act=import">批量导入采购单</a></li>-->
    </ul>
</div>
<div class="mrightTop">
    <div class="fontl">
        <form method="get">
             <div class="left">
                ...
                日期从:<input class="queryInput pick_date" type="text" value="<?php echo $this->_var['query']['add_time_from']; ?>" id="add_time_from" name="add_time_from" />
...
<div class="tdare">
    <table width="100%" cellspacing="0" class="dataTable">
        ...
        <tr class="tatr1">
            <td width="11%" class="firstCell">单号</td>
            <td width="8%" class="table-center">日期</td>
            <td>供应商</td>
        	<td width="10%">供应商单号</td>
            <td width="6%" class="table-center">类型</td>
            <td width="6%">盘盈出库数量</td>
            <td width="7%">金额</td>
            <td width="7%">已结算金额</td>
...
?>
        <tr class="tatr2"<?php if ($this->_var['order']['is_void'] == '1'): ?> style="color:#F00;"<?php endif; ?>>
            ...
            <td class="table-center"><?php if ($this->_var['order']['purchase_type'] == 0): ?>盘盈入库<?php elseif ($this->_var['order']['purchase_type'] == 2): ?><span style="color:red;">盘亏出库</span><?php else: ?>其他<?php endif; ?></td>
            ...
            <td class="table-center">
              <a href="index.php?app=inventory&amp;act=view&amp;id=<?php echo $this->_var['order']['purchase_id']; ?>">查看</a>
    ...
    <table width="100%" cellspacing="0" class="dataTable">
    	<thead>
        <tr class="tatr1">
            <td width="70" class="firstCell">盘盈出库数量</td>
            <td width="150">金额</td>
            <td width="150">已结算金额</td>
            <td>未结算金额</td>
            <td width="100" class="firstCell">盘亏入库数量</td>
