...
<div class="tdare">
    <table width="100%" cellspacing="0" class="dataTable">
        ...
        <tr class="tatr2" style="background-color:#E1FFF0;">
            ...
            <td class="table-center"><?php if ($this->_var['data']['refund_type'] == '0'): ?>其他<?php elseif ($this->_var['data']['refund_type'] == '1'): ?>世界窗<?php elseif ($this->_var['data']['refund_type'] == '2'): ?>淘宝<?php elseif ($this->_var['data']['refund_type'] == '3'): ?>网络<?php endif; ?></td>
