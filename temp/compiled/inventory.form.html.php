			...
			if (v > 0){
				$.getJSON("index.php?app=purchase&act=get_goods", {id: v}, function(data){
					if (data.done){
						...
						obj.parents('tr').find('td input[name="price_purchase[]"]').val(data.retval.price_average);
...
function add_tr(){
	var html = '<tr class="tatr2" style="background-color:#E1FFF0;">'+
			   ...
			   '<td><select class="infoTableInput2 select_search" name="goods_id[]"><?php echo $this->html_options(array('options'=>$this->_var['goods'])); ?></select></td>'+
			   ...
			   '<td><input class="infoTableInput3" type="text" name="price_purchase[]" value="" style="width:55px;"  readonly="readonly" /><input name="price_average" type="hidden" value="0" /></td>'+
...
<div class="tdare">
    <table width="100%" cellspacing="0" class="dataTable">
        ...
        <tr class="tatr1" style="background-color:#B9FFFF;">
            <td width="15%" class="firstCell">单号</td>
            <td width="13%">日期</td>
            <td width="1%">&nbsp;</td>
        	<td width="1%"></td>
            <td width="6%">类型</td>
        ...
        <tr class="tatr2" style="background-color:#E1FFF0;">
            ...
            <td><input name="buyer" type="text" class="infoTableInput3" id="buyer" value="<?php echo $this->_var['visitor']['user_name']; ?>" readonly="readonly" /></td>
            <td>
    ...
    <table width="100%" cellspacing="0" class="dataTable" id="input_tr">
        ...
        <tr class="tatr2" style="background-color:#E1FFF0;">
            <td class="firstCell"><input class="infoTableInput3" type="text" name="goods_sn[]" value="" style="width:85px;" readonly="readonly" /></td>
            <td>
                <select class="infoTableInput2 select_search" name="goods_id[]">
            ...
            <td><input name="price_purchase[]" type="text" class="infoTableInput3" style="width:55px;" value="" readonly="readonly" /><input name="price_average" type="hidden" value="0" /></td>
            <td><input class="infoTableInput3" type="text" name="discount[]" value="" style="width:45px;" /></td>
            <td><input class="infoTableInput3" type="text" name="quantity[]" value="" style="width:45px;" /></td>
            <td><input class="infoTableInput3" type="text" name="money[]" value="" /></td>
            <td><input class="infoTableInput3" type="text" name="remark[]" value="" /></td>
    ...
    <table width="100%" cellspacing="0" class="dataTable">
    	<thead>
        <tr class="tatr1" style="background-color: #B9FFFF;">
            <td width="12%" class="firstCell">盘盈出库数量</td>
            <td width="12%">金额</td>
