...
<title>商城后台 - worldmall.cn</title>
<link href="themes/style/admin.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="<?php echo $this->lib_base . "/" . 'jquery-1.3.2.js'; ?>" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo $this->lib_base . "/" . 'jquery.extend-1.0.js'; ?>" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo $this->lib_base . "/" . 'common-3.0.js'; ?>" charset="utf-8"></script>
...
?>
    ...
    <div class="close_float"><img src="themes/style/images/close2.gif" /></div>
</div>
<div id="head">
    <!--<div id="logo"><a href="index.php"><img src="themes/style/images/logo.png" alt="ECMall" /></a></div>-->
    <div id="menu"><span>您好，<strong><?php echo $this->_var['visitor']['user_name']; ?></strong> <a href="index.php?act=logout">[退出]</a></span>
    <a href="javascript:;" class="menu_btn2" id="item_edit_user">修改密码</a>
    <a href="javascript:;" class="menu_btn1" id="iframe_refresh">刷新</a>
    <!--<a href="javascript:;" class="menu_btn2" id="clear_cache">更新缓存</a>-->
    <a href="#" id="back_btn"><img src="themes/style/images/tiring_room_nav.gif" /></a>
    </div>
    <ul id="nav">
    </ul>
    <div id="headBg"></div>
