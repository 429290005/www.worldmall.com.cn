<?php /* Smarty version Smarty-3.0.6, created on 2012-10-23 14:19:17
         compiled from "E:\wamp\www\shamo\www/template\admin/shopcat_list.html" */ ?>
<?php /*%%SmartyHeaderCode:2935508636e5b03e27-43169672%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fa5e2475c8431580a4afe81ff359db35eb64cd80' => 
    array (
      0 => 'E:\\wamp\\www\\shamo\\www/template\\admin/shopcat_list.html',
      1 => 1350973155,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2935508636e5b03e27-43169672',
  'function' => 
  array (
  ),
...
<h1>
<span class="action-span1"><a href="#">地址列表</a> </span>
<span class="action-span"><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'shopcat','a'=>'addpage'),$_smarty_tpl);?>
">添加地址</a></span>
</h1>
...
em" />
      <?php }?>
      <span><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'shop','a'=>'index','cat_id'=>$_smarty_tpl->tpl_vars['cat']->value['id'],'pid'=>$_smarty_tpl->tpl_vars['cat']->value['id']),$_smarty_tpl);?>
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['cat']->value['catename']);?>
    ...
    <td width="24%" align="right" class="nowrap" valign="top"><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'shopcat','a'=>'editpage','id'=>$_smarty_tpl->tpl_vars['cat']->value['id'],'pid'=>$_smarty_tpl->tpl_vars['cat']->value['pid']),$_smarty_tpl);?>
">编辑</a>
	
	&nbsp;|&nbsp;<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'shopcat','a'=>'delete','id'=>$_smarty_tpl->tpl_vars['cat']->value['id'],'pid'=>$_smarty_tpl->tpl_vars['cat']->value['pid']),$_smarty_tpl);?>
