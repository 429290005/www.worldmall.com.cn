<?php /* Smarty version Smarty-3.0.6, created on 2012-08-14 17:43:49
         compiled from "E:\wamp\www\mianmian\www/template\admin/articlecat_list.html" */ ?>
<?php /*%%SmartyHeaderCode:21992502a1dd54ea7c2-37962767%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '82999acda7a7c17d581662e0661b75f225291d4f' => 
    array (
      0 => 'E:\\wamp\\www\\mianmian\\www/template\\admin/articlecat_list.html',
      1 => 1339464725,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21992502a1dd54ea7c2-37962767',
  'function' => 
  array (
  ),
...
<h1>
<span class="action-span1"><a href="#">文章分类列表</a> </span>
<span class="action-span"><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'articlecat','a'=>'addpage'),$_smarty_tpl);?>
">添加文章分类</a></span>
</h1>
...
em" />
      <?php }?>
      <span><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'article','a'=>'index','cat_id'=>$_smarty_tpl->tpl_vars['cat']->value['id'],'pid'=>$_smarty_tpl->tpl_vars['cat']->value['id']),$_smarty_tpl);?>
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['cat']->value['catename']);?>
    ...
    <td width="24%" align="right" class="nowrap" valign="top"><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'articlecat','a'=>'editpage','id'=>$_smarty_tpl->tpl_vars['cat']->value['id'],'pid'=>$_smarty_tpl->tpl_vars['cat']->value['pid']),$_smarty_tpl);?>
">编辑</a>
	
	&nbsp;|&nbsp;<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'articlecat','a'=>'delete','id'=>$_smarty_tpl->tpl_vars['cat']->value['id'],'pid'=>$_smarty_tpl->tpl_vars['cat']->value['pid']),$_smarty_tpl);?>
