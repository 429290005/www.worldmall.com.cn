<?php /* Smarty version Smarty-3.0.6, created on 2012-10-23 14:05:14
         compiled from "E:\wamp\www\shamo\www/template\admin/resume_list.html" */ ?>
<?php /*%%SmartyHeaderCode:121755086339a5a3da5-59277015%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '832ce8e43a51fad4aa42b7493408ae49253e8da9' => 
    array (
      0 => 'E:\\wamp\\www\\shamo\\www/template\\admin/resume_list.html',
      1 => 1350971958,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '121755086339a5a3da5-59277015',
  'function' => 
  array (
  ),
...
<h1>
<span class="action-span1"><a href="#">简历列表</a> </span>
<span class="action-span"><!-- <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'resumes','a'=>'addpage'),$_smarty_tpl);?>
">添加管理员</a> --></span>
</h1>
<!-- <div class="form-div">
...
"> --><?php echo $_smarty_tpl->tpl_vars['user_list']->value['id'];?>
	...
	<td align="center">&nbsp;&nbsp;&nbsp;<strong><?php echo $_smarty_tpl->tpl_vars['user_list']->value['sex'];?>
</strong></td>
	<td align="center">&nbsp;&nbsp;&nbsp;<strong><?php echo $_smarty_tpl->tpl_vars['user_list']->value['birthplace'];?>
</strong></td>
    <td align="center">
    <span>
      <!--<a title="查看" target="_blank"><img width="16" height="16" border="0" src="themes/admin/images/icon_view.gif"></a>&nbsp;-->
      <a title="编辑" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'resumes','a'=>'editpage','id'=>$_smarty_tpl->tpl_vars['user_list']->value['id']),$_smarty_tpl);?>
"><img width="16" height="16" border="0" src="themes/admin/images/icon_edit.gif"></a>&nbsp;
      <a title="移除" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'resumes','a'=>'delete','id'=>$_smarty_tpl->tpl_vars['user_list']->value['id']),$_smarty_tpl);?>
...
条信息）：  
            ...
            <?php if ($_smarty_tpl->getVariable('pager')->value['current_page']!=$_smarty_tpl->getVariable('pager')->value['first_page']){?>  
                <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'resumes','a'=>'index','page'=>$_smarty_tpl->getVariable('pager')->value['first_page']),$_smarty_tpl);?>
">前页</a> |  
                <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'resumes','a'=>'index','page'=>$_smarty_tpl->getVariable('pager')->value['prev_page']),$_smarty_tpl);?>
">上一页</a> |  
            <?php }?>  
...
?>  
                <?php if ($_smarty_tpl->tpl_vars['thepage']->value!=$_smarty_tpl->getVariable('pager')->value['current_page']){?>  
                     <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'resumes','a'=>'index','page'=>$_smarty_tpl->tpl_vars['thepage']->value),$_smarty_tpl);?>
"><?php echo $_smarty_tpl->tpl_vars['thepage']->value;?>
            ...
            <?php if ($_smarty_tpl->getVariable('pager')->value['current_page']!=$_smarty_tpl->getVariable('pager')->value['last_page']){?> |  
                <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'resumes','a'=>'index','page'=>$_smarty_tpl->getVariable('pager')->value['next_page']),$_smarty_tpl);?>
">下一页</a> |  
                <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'resumes','a'=>'index','page'=>$_smarty_tpl->getVariable('pager')->value['last_page']),$_smarty_tpl);?>
">后页</a>  
            <?php }?>  
        <?php }?>
    </td>
