<?php /* Smarty version Smarty-3.0.6, created on 2012-08-15 09:22:46
         compiled from "E:\wamp\www\mianmian\www/template\admin/goodscolor_list.html" */ ?>
<?php /*%%SmartyHeaderCode:7228502af9e6999461-97062841%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fb4621922d0689ac57dad6d333c8421cd918fd2c' => 
    array (
      0 => 'E:\\wamp\\www\\mianmian\\www/template\\admin/goodscolor_list.html',
      1 => 1339464734,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7228502af9e6999461-97062841',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
)); /*/%%SmartyHeaderCode%%*/?>
<?php if (!is_callable('smarty_modifier_escape')) include 'E:\wamp\www\mianmian\www\SpeedPHP\Drivers\Smarty\plugins\modifier.escape.php';
...
<h1>
<span class="action-span1"><a href="#">属性列表</a> </span>
<span class="action-span"><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'goodscolor','a'=>'addpage'),$_smarty_tpl);?>
">添加属性</a></span>
</h1>
...
em" />
      <?php }?>
      <span><a href="<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['cat']->value['id'];?>
<?php $_tmp1=ob_get_clean();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'goodscolor','a'=>'index','pid'=>$_tmp1),$_smarty_tpl);?>
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['cat']->value['catename']);?>
    ...
    <td width="24%" align="right" class="nowrap" valign="top"><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'goodscolor','a'=>'editpage','id'=>$_smarty_tpl->tpl_vars['cat']->value['id']),$_smarty_tpl);?>
">编辑</a><?php if ($_smarty_tpl->tpl_vars['cat']->value['level']!=1){?>&nbsp;|&nbsp;<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'goodscolor','a'=>'delete','id'=>$_smarty_tpl->tpl_vars['cat']->value['id']),$_smarty_tpl);?>
" onclick="if(confirm('您确认要删除这条记录吗？')){return true}return false;">移除</a><?php }?></td>
  </tr>
  <?php }} ?>
</table>
