<?php /* Smarty version Smarty-3.0.6, created on 2012-09-15 10:03:44
         compiled from "D:\freehost\aosika\web/template\admin/user_edit.html" */ ?>
<?php /*%%SmartyHeaderCode:114375053e200454c35-41677484%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b5e61f914b422d47551569ee7e9b85de5784713e' => 
    array (
      0 => 'D:\\freehost\\aosika\\web/template\\admin/user_edit.html',
      1 => 1347612541,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '114375053e200454c35-41677484',
  'function' => 
  array (
  ),
...
"/>
  ...
  <tr>
    ...
    <td>
		...
		<input type="checkbox" name="menuflag[]" value="10003" <?php if (strpos($_smarty_tpl->getVariable('detail')->value['menuflag'],"10003")!==false){?> checked="checked" <?php }?>/>内页图片管理
...
" <?php if (strpos($_smarty_tpl->getVariable('detail')->value['menuflag'],($_smarty_tpl->tpl_vars['article_cat']->value['id']))!==false){?> checked="checked" <?php }?>/><?php echo $_smarty_tpl->tpl_vars['article_cat']->value['catename'];?>
		...
		<?php }} ?>
		<input type="checkbox" name="menuflag[]" value="10005" <?php if (strpos($_smarty_tpl->getVariable('detail')->value['menuflag'],"10005")!==false){?> checked="checked" <?php }?>/>属性管理
