<?php /* Smarty version Smarty-3.0.6, created on 2012-09-18 10:49:21
         compiled from "D:\freehost\aosika\web/template\admin/pageimg_list.html" */ ?>
<?php /*%%SmartyHeaderCode:281735057e131dfd147-70952320%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '018b23475b84efc5e8a38636328927b4866d58f1' => 
    array (
      0 => 'D:\\freehost\\aosika\\web/template\\admin/pageimg_list.html',
      1 => 1347936559,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '281735057e131dfd147-70952320',
  'function' => 
  array (
  ),
...
<span class="action-span"><?php if ($_GET['nid']==2){?><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'pageimg','a'=>'addpage','nid'=>$_GET['nid']),$_smarty_tpl);?>
">添加友情链接</a><?php }?></span>
</h1>
...
"><img width="16" height="16" border="0" src="themes/admin/images/icon_edit.gif"></a>&nbsp;
      <?php if ($_GET['nid']==2){?><a title="移除" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'pageimg','a'=>'delete','id'=>$_smarty_tpl->tpl_vars['pageimg_list']->value['id'],'nid'=>$_GET['nid']),$_smarty_tpl);?>
