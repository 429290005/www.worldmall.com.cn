<?php /* Smarty version Smarty-3.0.6, created on 2013-03-22 10:35:10
         compiled from "/var/local/worldmall/www.zgpjzd.com/template/admin/pageimg_list.html" */ ?>
<?php /*%%SmartyHeaderCode:1077015319514bc35ea51370-01760300%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b5f65dd6ff7edb99ce75346222f6db6d2de188c3' => 
    array (
      0 => '/var/local/worldmall/www.zgpjzd.com/template/admin/pageimg_list.html',
      1 => 1351532940,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1077015319514bc35ea51370-01760300',
  'function' => 
  array (
  ),
...
<h1>
<span class="action-span1"><a href="#"><?php if ($_GET['nid']!=2){?>图片列表<?php }else{ ?>友情链接列表<?php }?></a> </span>
<span class="action-span"><?php if ($_GET['nid']==2||$_GET['nid']==3){?><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'pageimg','a'=>'addpage','nid'=>$_GET['nid']),$_smarty_tpl);?>
">添加友情链接</a><?php }?></span>
</h1>
...
" /></td>
	<?php }else{ ?>
	<td align="center"><?php echo $_smarty_tpl->tpl_vars['pageimg_list']->value['description'];?>
</td>
	<?php }?>
...
"><img width="16" height="16" border="0" src="themes/admin/images/icon_edit.gif"></a>&nbsp;
      <?php if ($_GET['nid']==2||$_GET['nid']==3){?><a title="移除" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'pageimg','a'=>'delete','id'=>$_smarty_tpl->tpl_vars['pageimg_list']->value['id'],'nid'=>$_GET['nid']),$_smarty_tpl);?>
