<?php /* Smarty version Smarty-3.0.6, created on 2012-12-27 15:17:11
         compiled from "/var/local/worldmall/www.zgpjzd.com/template/admin/article_edit.html" */ ?>
<?php /*%%SmartyHeaderCode:70381141550dbf5f7e13273-99189010%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'af03ee4650872354252b8b2758b532c0b5d6feeb' => 
    array (
      0 => '/var/local/worldmall/www.zgpjzd.com/template/admin/article_edit.html',
      1 => 1352265960,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '70381141550dbf5f7e13273-99189010',
  'function' => 
  array (
  ),
...
" onClick="WdatePicker()"/>
  ...
  <tr>
    ...
    <td>
      <?php if ($_smarty_tpl->getVariable('detail')->value['upfile']!=''){?><img src="uploads/article/<?php echo $_smarty_tpl->getVariable('detail')->value['upfile'];?>
"/><?php }else{ ?><img src="themes/index/images/nopic.gif"/><?php }?>
  ...
  <tr>
    ...
    <td>
      <input type="file" name="upfile"/>&nbsp;&nbsp;&nbsp;<?php if ($_smarty_tpl->getVariable('detail')->value['upfile']!=null){?><img src="themes/admin/images/yes.gif" /><?php }else{ ?><img src="themes/admin/images/no.gif" /><?php }?>  最佳大小 198*199px
    </td>
  </tr>
