<?php /* Smarty version Smarty-3.0.6, created on 2012-10-23 14:21:16
         compiled from "E:\wamp\www\shamo\www/template\admin/shop_edit.html" */ ?>
<?php /*%%SmartyHeaderCode:137395086375c954997-15052080%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f342950b2885d4572aabc504df4a65effe0abb19' => 
    array (
      0 => 'E:\\wamp\\www\\shamo\\www/template\\admin/shop_edit.html',
      1 => 1350973250,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '137395086375c954997-15052080',
  'function' => 
  array (
  ),
...
<h1>
<span class="action-span1"><a href="#">修改网点</a> </span>
<span class="action-span"><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'shop','a'=>'index','pid'=>$_GET['pid']),$_smarty_tpl);?>
">网点列表</a></span>
</h1>
<div class="main-div">
<form method="post" action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'shop','a'=>'update'),$_smarty_tpl);?>
...
" onClick="WdatePicker()"/>
  ...
  <tr style="display:none">
    ...
    <td>
      <?php if ($_smarty_tpl->getVariable('detail')->value['upfile']!=''){?><img src="uploads/sm_shop/<?php echo $_smarty_tpl->getVariable('detail')->value['upfile'];?>
