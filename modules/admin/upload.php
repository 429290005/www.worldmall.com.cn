...
// Settings
	$save_path = dirname(__FILENAME__) . "../../uploads/files/";				// The path were we will save the file (getcwd() may not be reliable and should be tested in your environment)
	$upload_name = "Filedata";
	$max_file_size_in_bytes = 2147483647;				// 2GB in bytes
	$extension_whitelist = array("jpg", "gif", "png","rar","xls","doc","xlsx");	// Allowed file extensions
...
/*	$fileb=$_FILES[$upload_name]['name'];
    $file_ext = substr($fileb, strrpos($fileb, ".")+1);
...
// Process the file
	...
	*/
	if (!@move_uploaded_file($_FILES[$upload_name]["tmp_name"], $save_path.$file_name)) {
		...
		mysql_query("INSERT INTO download (id,name) VALUES (NULL,'$file_name')");	
	}*/
