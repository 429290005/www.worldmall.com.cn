...
<!--头部 结束 -->
<!--banner 开始 -->
<div id="banner"><img src="/skin/default/images/contant.jpg" alt="联系我们" /></div>
<!--banner 结束 -->
<!--内容主体 开始 -->
<div class="main">
	<!--二级菜单 开始 -->
	<div class="menu"><a class="current">联系我们</a><a href="/lianxiwomen/zhaoxiannashi/">招贤纳士</a><a href="/lianxiwomen/zaixianliuyan/">在线留言</a></div>
	<!--二级菜单 结束 -->
	<!--内容 开始 -->
	<div class="content">
