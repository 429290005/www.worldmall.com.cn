...
<section>
	...
	<article class="bd news">
		<ul id="movenews">
                               <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(45,9,0,1,'','newstime DESC');
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
?>
...
?>
		...
		<a class="pageBtn movenews" href="javascript:;">点击查看更多</a>
...
$(document).ready(function(){
        $(".movenews").live("click",function(){
        	   ...
        	   $(this).attr("_val","yes");
                var _this = $(this);
               var size = $("#movenews li").size();
               $.ajax({
                     type:'post',
                     url:"/e/clickmore.php",
                     data:{size:size,id:45},
                     dataType:'json',
