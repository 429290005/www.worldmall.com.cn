...
$phome_db_password='Nb_DB*2!#$';	//数据库密码
$phome_db_dbname='worldhome';	//数据库名
...
$do_ecookiernd='e7AVG4JeL8j85KW6kfaA4HmpeyNwcb';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$phome_cookievarpre='qtuhs';		//前台cookie变量前缀
$phome_cookieadminvarpre='ygnkd';		//后台cookie变量前缀
$phome_cookieckrnd='NkDiAWYTWixRcxy5nrPh6zRfAXFe7J';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
...
//------------e_public
$public_r=array('sitename'=>'世界窗团体网站',
'newsurl'=>'/',
...
'candocode'=>1,
'opennotcj'=>0,
'listpagetemp'=>'<div class=\"page\">[!--pagelink--]&nbsp;&nbsp;&nbsp;&nbsp;</div>',
'reuserpagenum'=>50,
'revotejsnum'=>100,
'readjsnum'=>100,
'qaddtran'=>1,
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'XDx28GgVLeL6c27bzTNKchNSb4Yuub',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/gongsijieshao/\">公司介绍</a>&nbsp;|&nbsp;<a href=\"/qixiayewu/\">旗下业务</a>&nbsp;|&nbsp;<a href=\"/pinpaihezuo/\">品牌合作</a>&nbsp;|&nbsp;<a href=\"/chenggonganlis/\">成功案例</a>&nbsp;|&nbsp;<a href=\"/zuixindongtais/\">最新动态</a>&nbsp;|&nbsp;<a href=\"/lianxiwomen/\">联系我们</a>',
'plgroupid'=>0,
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
...
'fs_purl'=>'',
'closemods'=>'',
'deftempid'=>0,'add_about'=>'<h2>广东新汇豪投资有限公司</h2>
<p>地址：广州市走马岗路2号盛豪大厦3层 </p>
<p>电话： 020-86378968    020-86375298</p>
<p>时间：周一至周五：9：00-18：00（法定节假日除外）</p>
<p>世界窗品汇网：www.worldmall.com.cn </p>
<p>世界窗皮具网：www.worldmall.cn</p>','add_ly'=>'<h3>尊敬的客户朋友：</h3>
...
'definfovoteid'=>0,
'orderf'=>'',
'sonclass'=>'|21|25|23|26|28|29|30|31|35|46|45|49|',
'tid'=>1,
'tbname'=>'news');
...
'listtempf'=>',title,newstime,titlepic,smalltext,writer,befrom,newstext,diggtop,',
'tempf'=>',title,newstime,titlepic,smalltext,writer,befrom,newstext,diggtop,',
'mustqenterf'=>',title,newstext,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,smalltext,newstext,',
...
'tbdataf'=>',',
'tobrf'=>',title,special.field,titlepic,newstime,smalltext,writer,befrom,newstext,diggtop,',
'dohtmlf'=>',title,special.field,titlepic,newstime,smalltext,writer,befrom,newstext,diggtop,',
'checkboxf'=>',',
'savetxtf'=>'newstext',
'editorf'=>',newstext,',
'ubbeditorf'=>',',
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,special.field,newstime,address,num,demand,job,needs,treatment,',
'qenter'=>',title,special.field,newstime,address,num,demand,job,needs,treatment,',
'listtempf'=>',title,titlepic,newstime,address,num,demand,job,needs,treatment,',
'tempf'=>',title,titlepic,newstime,address,num,demand,job,needs,treatment,',
'mustqenterf'=>',title,newstime,address,num,demand,job,needs,treatment,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,',
'cj'=>',title,',
'canaddf'=>',title,newstime,address,num,demand,job,needs,treatment,',
'caneditf'=>',title,newstime,address,num,demand,job,needs,treatment,',
'tbdataf'=>',',
'tobrf'=>',demand,needs,treatment,',
'dohtmlf'=>',demand,job,needs,treatment,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',',
'ubbeditorf'=>',',
