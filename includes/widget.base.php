...
class BaseWidget extends Object
{
    ...
    {
        $this->id = $id;
        $this->widget_path = ROOT_PATH . '/external/widgets/' . $this->_get_template_name() . '/' . $this->_name;
        $this->widget_root = SITE_URL . '/external/widgets/' . $this->_get_template_name() . '/' . $this->_name;
 ...
 */
function &widget($id, $name, $options = array(), $template_name = 'default')
{
    static $widgets = null;
    if (!isset($widgets[$id]))
    {
        $widget_class_path = ROOT_PATH . '/external/widgets/' . $template_name . '/' . $name . '/main.widget.php';
