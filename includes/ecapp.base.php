...
define('DOC_FILE_TYPE', 'doc|docx|xls|xlsx||csv'); //文档类型

define('SIZE_GOODS_IMAGE', '2097152');   // 商品大小限制2M
define('SIZE_STORE_LOGO', '40480');      // 店铺LOGO大小限制2OK
...
define('SIZE_STORE_FAPIAO', '1048576');  // 发票凭证大小限制1M
define('SIZE_DOC', '10485760');           // 文档大小限制10M
