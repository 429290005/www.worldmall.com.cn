    ...
    function get_default()
    {
        return array(
            ...
            'touser_find_password' => array(
                'description' => Lang::get('touser_find_password_desc'),
            ),
            'tobuyer_question_replied' => array(
                'description' => Lang::get('tobuyer_question_replied_desc'),
            ),
            'touser_send_coupon' => array(
                'description' => Lang::get('touser_send_coupon_desc'),
            ),
            'toseller_offline_cash_pay_success_notify' => array(
                'description' => Lang::get('toseller_offline_cash_pay_success_desc'),
            ),
            'toseller_refund_processing_results_notify' => array(
                'description' => Lang::get('toseller_refund_processing_results_desc'),
            ),
            'tobuyer_refund_processing_results_notify' => array(
                'description' => Lang::get('tobuyer_refund_processing_results_desc'),
            ),
            'toseller_refund_confirm_notify' => array(
                'description' => Lang::get('toseller_refund_confirm_desc'),
            ),
            'toseller_refund_goods_notify' => array(
                'description' => Lang::get('toseller_refund_goods_desc'),
            ),
            'tobuyer_refund_confirm_notify' => array(
                'description' => Lang::get('tobuyer_refund_confirm_desc'),
            ),
            'tobuyer_refund_goods_notify' => array(
                'description' => Lang::get('tobuyer_refund_goods_desc'),
            ),
        );
    }
    function getOne($key)
