...
function initTopTab(){
    ...
    $('#item_edit_user').click(function(){
		$('#workspace').show();
		$('#workspace').attr('src', 'index.php?act=edit_user');
    });
...
function addHistoryItem(tab, item){
    ...
    if($(id).length == 1){
        ...
        var close = $('<a href="javascript:;" class="close"><img src="themes/style/images/close.gif" / ></a>');
        lnk.click(function(){
            openItem(item, tab);
        });
